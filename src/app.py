...
activities = {
    ...
    "Basketball Team": {
        "description": "Competitive basketball practice and interscholastic games",
    ...
    "Theater Production": {
        "description": "Act, direct, and produce school theatrical performances",
        "schedule": "Thursdays, 3:30 PM - 5:30 PM",
        "max_participants": 25,
        "participants": ["marcus@mergington.edu", "zoe@mergington.edu"]
    },
    "Debate Team": {
